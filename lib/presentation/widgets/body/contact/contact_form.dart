...
import 'package:pf/core/widgets/custom_button.dart';
import 'package:pf/presentation/blocs/home_bloc/home_bloc.dart';
          ...
          children: [
            ...
            BlocBuilder<HomeBloc, HomeState>(
              builder: (context, state) {
                return CustomButton(
                  label: state is SentMail
                      ? 'Sent'
                      : state is SendingMail
                          ? 'Sending Mail..'
                          : state is FailedToSendEmail
                              ? 'Could not send.'
                              : 'Submit',
                  onPressed: (state is SendingMail || state is FailedToSendEmail)
                      ? null
                      : () async {
